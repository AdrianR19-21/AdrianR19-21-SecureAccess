...
if (!process.env.DATABASE_URL) {
	// Prefer a project-local SQLite file by default. For production deployments
	// (Vercel and similar) it's strongly recommended to set `DATABASE_URL`
	// to an external, persistent database (Supabase, PlanetScale, etc.).
	// Using a local file in production may be ephemeral depending on the host.
